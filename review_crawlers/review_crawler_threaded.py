...
extn_identifier = ["doojmbjmlfjjnbmnoijecmcbfeoakpjm", "cfhdojbkjhnklbpkdaibdccddilifddb", "cjpalhdlnbpafiamejdnhcphjbkeiagm", "mlomiejdfkolichcflejclcbmpeaniij", "gcbommkclmclpchllfjekcdonpmejbdp", "jeoacafpbcihiomhlakheieifhpjdfeo", "pkehgijcmpdhfbdbbnkijodmdjhbjlgp", "lanfdkkpgfjfdikkncbnojekcppdebfp", "djflhoibgkdhkhhcedjiklpkjnoahfmg", "oiigbmnaadbkfbmpbfijlflahbdbdgdf", "ldpochfccmkkmhdbclfhpagapcfdljkj", "bgnkhhnnamicmpeenaelnjfhikgbkllg", "nngceckbapebfimnlniiiahkandclblb", "ahnanjpbkghcdgmlchbcfoiefnifjeni"]
extn_lst = ["noscript", "adblock-plus-free-ad-bloc", "ublock-origin", "ghostery-–-privacy-ad-blo", "https-everywhere", "disconnect", "privacy-badger", "canvas-fingerprint-defend", "user-agent-switcher-for-c", "scriptsafe", "decentraleyes", "adguard-adblocker", "bitwarden-free-password-m", "no-script-suite-lite"]
...
for extn_num in range(1):#len(extn_lst)):
...
# pretty_write_to_textfile(review_dict, "pretty_review_t.txt")
# write_to_textfile(review_dict, "review_t.txt")
# write_to_pickle(review_dict, "review_t.pickle")
pretty_write_to_textfile(review_dict, "pretty_noscript_t.txt")
write_to_textfile(review_dict, "noscript_t.txt")
write_to_pickle(review_dict, "noscript_t.pickle")